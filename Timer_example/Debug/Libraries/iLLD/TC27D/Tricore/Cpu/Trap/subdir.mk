...
Libraries/iLLD/TC27D/Tricore/Cpu/Trap/%.src: ../Libraries/iLLD/TC27D/Tricore/Cpu/Trap/%.c Libraries/iLLD/TC27D/Tricore/Cpu/Trap/subdir.mk
	...
	cctc -cs --dep-file="$(basename $@).d" --misrac-version=2004 -D__CPU__=tc27xd "-fC:/workspace/AURIX_Project/Timer_example/Debug/TASKING_C_C___Compiler-Include_paths__-I_.opt" --iso=99 --c++14 --language=+volatile --exceptions --anachronisms --fp-model=3 -O0 --tradeoff=4 --compact-max-size=200 -g -Wc-w544 -Wc-w557 -Ctc27xd -Y0 -N0 -Z0 -o "$@" "$<" && \
...
Libraries/iLLD/TC27D/Tricore/Cpu/Trap/%.o: ./Libraries/iLLD/TC27D/Tricore/Cpu/Trap/%.src Libraries/iLLD/TC27D/Tricore/Cpu/Trap/subdir.mk
	@echo 'Building file: $<'
