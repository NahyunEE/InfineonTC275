...
//
    ...
    ////////////////////////////////////////////
    //SET IGP0
    //Do not consider Pattern DetectionR
...
void initERU1(){
    ...
    SCU_EICR1.U &= ~(0x7 << INP1_IDX); //OGU1 Connect
    SCU_EICR1.U |= 0x1 <<INP1_IDX; //

    ////////////////////////////////////////////////

    //Select OGU 1
    //Interrupt Gating Controller Register
    SCU_IGCR0.U &= ~(0x3 << IGP1_IDX);
    SCU_IGCR0.U |= 0x1 << IGP1_IDX;

    //General Service Request Register
...
void ISR0(){
       sig = ~sig;
       P10_OUT.U |= sig << P2_IDX;
}

void ISR1(){
    sig1 = ~sig1;
    P10_OUT.U |= sig1 << P1_IDX;
}
